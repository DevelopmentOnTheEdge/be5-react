import React, { Component, useState, useEffect, useCallback, useRef, createContext, forwardRef, createElement, Fragment, PureComponent } from 'react';
...
function _defineProperties$p(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey$z(o.key), o); } }
...
var FrontendAction = /*#__PURE__*/_createClass$p(function FrontendAction(type, value) {
  _classCallCheck$p(this, FrontendAction);
  this.type = type;
  this.value = value;
});
...
function _defineProperty$f(e, r, t) { return (r = _toPropertyKey$y(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
function _defineProperty$e(e, r, t) { return (r = _toPropertyKey$x(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
    ...
    requestUrl: function requestUrl(url, type, params, _success, failure) {
      ...
      $.ajax({
        ...
        success: function success(data, status, xhr) {
          ...
          if (_typeof$y(data) === 'object' && data.type === 'error') {
            if (_typeof$y(data.value) !== 'object') {
              data.value = {
...
function _defineProperty$d(e, r, t) { return (r = _toPropertyKey$w(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
function _defineProperty$c(e, r, t) { return (r = _toPropertyKey$v(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
var _buildFormDateFromObject = function _buildFormDateFromObject(formData, data, parentKey) {
  if (data && _typeof$w(data) === 'object' && !(data instanceof Date) && !(data instanceof File)) {
...
var MenuBody = /*#__PURE__*/function (_Component) {
  function MenuBody(props) {
    var _this;
    _classCallCheck$o(this, MenuBody);
    _this = _callSuper$n(this, MenuBody, [props]);
    _this.state = {
      query: ''
    };
  ...
  _inherits$o(MenuBody, _Component);
  return _createClass$o(MenuBody, [{
    key: "render",
...
var MenuSearchField = /*#__PURE__*/function (_React$Component) {
  function MenuSearchField(props) {
    var _this;
    _classCallCheck$n(this, MenuSearchField);
    _this = _callSuper$m(this, MenuSearchField, [props]);
    _this.state = {
      value: ''
    };
  ...
  _inherits$n(MenuSearchField, _React$Component);
  return _createClass$n(MenuSearchField, [{
    key: "render",
    value: function render() {
...
var Menu$1 = /*#__PURE__*/function (_Component) {
  function Menu(props) {
    var _this;
    _classCallCheck$m(this, Menu);
    _this = _callSuper$l(this, Menu, [props]);
    _this._handleQueryChange = _this._handleQueryChange.bind(_this);
    return _this;
  }
  _inherits$m(Menu, _Component);
  return _createClass$m(Menu, [{
...
var Language = function Language(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNames$1("language", {
...
Language.propTypes = {
  code: PropTypes__default.string.isRequired,
...
function useLanguageSelector() {
  ...
  var changeLanguage = useCallback(function (language) {
...
var LanguageList = function LanguageList(_ref2) {
  ...
  var selected = data.selected ? data.selected.toUpperCase() : '';
  return /*#__PURE__*/React.createElement("div", {
...
LanguageList.propTypes = {
  data: PropTypes__default.shape({
    languages: PropTypes__default.arrayOf(PropTypes__default.string).isRequired,
    selected: PropTypes__default.string
  }).isRequired,
  onLanguageClick: PropTypes__default.func.isRequired
};
var LanguageBox = function LanguageBox(_ref3) {
  var className = _ref3.className;
  var _useLanguageSelector = useLanguageSelector(),
    data = _useLanguageSelector.data,
    changeLanguage = _useLanguageSelector.changeLanguage;
  if (!data.languages || data.languages.length <= 1) return null;
  return /*#__PURE__*/React.createElement("div", {
    className: classNames$1('languageBox', className)
  }, /*#__PURE__*/React.createElement(LanguageList, {
    data: data,
    onLanguageClick: changeLanguage
  }));
};
var LanguageDropdown = function LanguageDropdown(_ref4) {
  var className = _ref4.className;
  var _useLanguageSelector2 = useLanguageSelector(),
    data = _useLanguageSelector2.data,
    changeLanguage = _useLanguageSelector2.changeLanguage;
  if (!data.languages || data.languages.length <= 1) return null;
  var selected = data.selected ? data.selected.toUpperCase() : '';
  return /*#__PURE__*/React.createElement("div", {
    className: classNames$1('languageDropdown', className)
...
var Document$1 = /*#__PURE__*/function (_React$Component) {
  function Document(props) {
    var _this;
    _classCallCheck$l(this, Document);
    _this = _callSuper$k(this, Document, [props]);
  ...
  _inherits$l(Document, _React$Component);
  return _createClass$l(Document, [{
    key: "UNSAFE_componentWillReceiveProps",
    value: function UNSAFE_componentWillReceiveProps(nextProps) {
...
var NavMenu = /*#__PURE__*/function (_Component) {
  function NavMenu(props) {
    _classCallCheck$k(this, NavMenu);
    return _callSuper$j(this, NavMenu, [props]);
  }
  _inherits$k(NavMenu, _Component);
  return _createClass$k(NavMenu, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.props.fetchMenu();
    }
...
function _defineProperty$b(e, r, t) { return (r = _toPropertyKey$p(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
var NavbarMenu = /*#__PURE__*/function (_Component) {
  function NavbarMenu(props) {
    var _this;
    _classCallCheck$j(this, NavbarMenu);
    _this = _callSuper$i(this, NavbarMenu, [props]);
  ...
  _inherits$j(NavbarMenu, _Component);
  return _createClass$j(NavbarMenu, [{
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
...
var HelpInfo = /*#__PURE__*/function (_React$Component) {
  function HelpInfo(props) {
    var _this;
    _classCallCheck$i(this, HelpInfo);
    _this = _callSuper$h(this, HelpInfo);
    _this.state = {
      isOpen: props.isOpen
    };
  ...
  _inherits$i(HelpInfo, _React$Component);
  return _createClass$i(HelpInfo, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      if (this.props.value) {
        be5.url.process({
...
var Error$1 = function Error(_ref) {
  ...
  var _useState = useState(false),
    ...
    helpCollapse = _useState2[0],
    setHelpCollapse = _useState2[1];
  var toggleHelpCollapse = function toggleHelpCollapse() {
    setHelpCollapse(function (prev) {
      return !prev;
    });
  };
  var renderFrontendHelp = function renderFrontendHelp() {
    if (status === '404' || status === '403') {
      var link = status === '404' ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("a", {
        href: "#!",
        className: "btn btn-primary"
      }, be5.messages.goToHomepage)) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("a", {
        href: "/",
        className: "btn btn-primary"
      }, be5.messages.goToHomepage));
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("h6", null, link));
    }
    return null;
  };
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "errorPane__title errorPane__title_".concat(status)
  }, status, " - ", title), renderFrontendHelp(), /*#__PURE__*/React.createElement("br", null), code !== undefined && /*#__PURE__*/React.createElement("pre", {
    className: "errorPane__code",
    dangerouslySetInnerHTML: {
      __html: code
    }
  }), detail !== undefined && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Button, {
    color: "info",
    className: "btn-sm",
...
Error$1.propTypes = {
  status: PropTypes__default.string.isRequired,
  title: PropTypes__default.string.isRequired,
  code: PropTypes__default.string,
  detail: PropTypes__default.string
};
var ErrorPane = function ErrorPane(_ref2) {
  var value = _ref2.value;
  var errors = value === null || value === void 0 ? void 0 : value.errors;
...
function _defineProperties$h(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey$n(o.key), o); } }
...
function _possibleConstructorReturn$h(t, e) { if (e && ("object" == _typeof$o(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return _assertThisInitialized$h(t); }
...
var FormWizard = /*#__PURE__*/function (_React$Component) {
  function FormWizard(props) {
    var _this;
    _classCallCheck$h(this, FormWizard);
    _this = _callSuper$g(this, FormWizard, [props]);
    _this.state = {
  ...
  _inherits$h(FormWizard, _React$Component);
  return _createClass$h(FormWizard, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.init();
    }
...
function _defineProperty$a(e, r, t) { return (r = _toPropertyKey$m(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
function _defineProperty$9(e, r, t) { return (r = _toPropertyKey$l(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
var Form = /*#__PURE__*/function (_React$Component) {
  function Form(props) {
    var _this;
    _classCallCheck$g(this, Form);
    _this = _callSuper$f(this, Form, [props]);
    _this.state = {
  ...
  _inherits$g(Form, _React$Component);
  return _createClass$g(Form, [{
    key: "componentDidMount",
    value: function componentDidMount() {
...
var HorizontalForm = /*#__PURE__*/function (_Form) {
  function HorizontalForm() {
    ...
    return _callSuper$e(this, HorizontalForm, arguments);
  }
  _inherits$f(HorizontalForm, _Form);
  return _createClass$f(HorizontalForm, [{
    key: "_createFormProperties",
    value: function _createFormProperties() {
      var attributes = this.props.value.data.attributes;
      return /*#__PURE__*/React.createElement(PropertySet, {
...
function _superPropBase$2(t, o) { for (; !{}.hasOwnProperty.call(t, o) && null !== (t = _getPrototypeOf$e(t));); return t; }
...
var SubmitOnChangeForm = /*#__PURE__*/function (_Form) {
  function SubmitOnChangeForm(props) {
    var _this;
    _classCallCheck$e(this, SubmitOnChangeForm);
    _this = _callSuper$d(this, SubmitOnChangeForm, [props]);
    _this._onFieldChangeAndSubmit = _this._onFieldChangeAndSubmit.bind(_this);
    return _this;
  }
  _inherits$e(SubmitOnChangeForm, _Form);
  return _createClass$e(SubmitOnChangeForm, [{
    key: "_onFieldChangeAndSubmit",
    value: function _onFieldChangeAndSubmit(name, value) {
      _get$2(_getPrototypeOf$e(SubmitOnChangeForm.prototype), "_setValue", this).call(this, name, value);
      _get$2(_getPrototypeOf$e(SubmitOnChangeForm.prototype), "apply", this).call(this);
    }
  }, {
    key: "render",
    value: function render() {
...
function _superPropBase$1(t, o) { for (; !{}.hasOwnProperty.call(t, o) && null !== (t = _getPrototypeOf$d(t));); return t; }
...
var ModalForm = /*#__PURE__*/function (_Form) {
  function ModalForm(props) {
    var _this;
    _classCallCheck$d(this, ModalForm);
    _this = _callSuper$c(this, ModalForm, [props]);
    _this.escListener = _this.escListener.bind(_this);
    return _this;
  }
  _inherits$d(ModalForm, _Form);
  return _createClass$d(ModalForm, [{
    key: "escListener",
    ...
    key: "componentDidMount",
    value: function componentDidMount() {
      _get$1(_getPrototypeOf$d(ModalForm.prototype), "componentDidMount", this).call(this);
      document.addEventListener('keydown', this.escListener, false);
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      _get$1(_getPrototypeOf$d(ModalForm.prototype), "componentWillUnmount", this).call(this);
...
var InlineMiniForm = /*#__PURE__*/function (_Form) {
  function InlineMiniForm() {
    _classCallCheck$c(this, InlineMiniForm);
    return _callSuper$b(this, InlineMiniForm, arguments);
  }
  _inherits$c(InlineMiniForm, _Form);
  return _createClass$c(InlineMiniForm, [{
    key: "render",
    value: function render() {
      var _this = this;
      var attributes = this.props.value.data.attributes;
...
var FinishedResult = function FinishedResult(_ref) {
...
var JsonFormatTableBox = function JsonFormatTableBox(_ref) {
  var value = _ref.value;
  var _value$data$attribute = value.data.attributes,
    columns = _value$data$attribute.columns,
    rows = _value$data$attribute.rows,
    parameters = _value$data$attribute.parameters,
    layout = _value$data$attribute.layout;
