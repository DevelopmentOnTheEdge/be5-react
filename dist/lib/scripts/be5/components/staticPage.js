...
var StaticPage = function (_React$Component) {
  ...
  _createClass(StaticPage, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'staticPage', dangerouslySetInnerHTML: { __html: content } });
    }
  }]);
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(StaticPage, 'StaticPage', 'src/scripts/be5/components/staticPage.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/scripts/be5/components/staticPage.js');
}();
