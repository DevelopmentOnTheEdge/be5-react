...
import {getSelfUrl, getModelByID, createStaticValue, getResourceByID, setUrlForHash} from './utils/documentUtils.js';
...
export {
  ...
  preconditions,
  arraysEqual,
  getSelfUrl, getModelByID, createStaticValue, getResourceByID, setUrlForHash,
